// DB 01.2019
#ifndef Alpos_AApfelxxReggeonCS
#define Alpos_AApfelxxReggeonCS
...
class AApfelxxReggeonCS : public AParmFuncBase<double> {

public:
   AApfelxxReggeonCS(const std::string& name);
   virtual ~AApfelxxReggeonCS();
