// DB 15.01.2015
#ifndef Alpos_AApfelDISCSEWFit
#define Alpos_AApfelDISCSEWFit
...
class AApfelDISCSEWFit : public AParmFuncBase<double> {

public:
   AApfelDISCSEWFit(const std::string& name);
   virtual ~AApfelDISCSEWFit();
