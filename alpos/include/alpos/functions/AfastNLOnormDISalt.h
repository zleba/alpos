// DB 15.01.2015
#ifndef Alpos_AfastNLOnormDISalt
#define Alpos_AfastNLOnormDISalt
...
class AfastNLOnormDISalt : public AParmFuncBase<double> , public fastNLOReader {

public:
   AfastNLOnormDISalt(const std::string& name);
   virtual ~AfastNLOnormDISalt();
