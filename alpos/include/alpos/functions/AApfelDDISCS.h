// DB 15.01.2015
#ifndef Alpos_AApfelDDISCS
#define Alpos_AApfelDDISCS
...
class AApfelDDISCS : public AParmFuncBase<double> {

public:
   AApfelDDISCS(const std::string& name);
   virtual ~AApfelDDISCS();
