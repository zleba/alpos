//
#ifndef Alpos_AFixedValues
#define Alpos_AFixedValues
...
//class AFixedValues : public AParmFuncBase<double> {
class AFixedValues : public AFuncD {

public:
   AFixedValues(const std::string& name);
   virtual ~AFixedValues();
