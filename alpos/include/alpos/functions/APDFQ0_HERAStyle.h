//
#ifndef Alpos_APDFQ0_HERAStyle
#define Alpos_APDFQ0_HERAStyle
...
//class APDFQ0_HERAStyle : public AParmFuncBase<double> {
class APDFQ0_HERAStyle : public AFuncD {

public:
   APDFQ0_HERAStyle(const std::string& name);
   virtual ~APDFQ0_HERAStyle();
