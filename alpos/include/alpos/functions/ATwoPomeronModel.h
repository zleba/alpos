//
#ifndef Alpos_ATwoPomeronModel
#define Alpos_ATwoPomeronModel
...
//class ATwoPomeronModel : public AParmFuncBase<double> {
class ATwoPomeronModel : public AFuncD {

public:
   ATwoPomeronModel(const std::string& name);
   virtual ~ATwoPomeronModel();
