// DB 07.2017
#ifndef Alpos_AApfelxxDISCS
#define Alpos_AApfelxxDISCS
...
class AApfelxxDISCS : public AParmFuncBase<double> {

public:
   AApfelxxDISCS(const std::string& name);
   virtual ~AApfelxxDISCS();
