//
#ifndef Alpos_ATwoPomeronParams
#define Alpos_ATwoPomeronParams
...
//class ATwoPomeronParams : public AParmFuncBase<double> {
class ATwoPomeronParams : public AFuncD {

public:
   ATwoPomeronParams(const std::string& name);
   virtual ~ATwoPomeronParams();
...
protected:
   double GetParValue(const std::string& tag, double q2);
   bool AreSame(double a, double b) const { return fabs(a - b) < 1.e-8;  }
};
