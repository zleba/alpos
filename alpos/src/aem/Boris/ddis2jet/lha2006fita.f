      subroutine H1evolvea(xin,qin,pdf)
      implicit real*8 (a-h,o-z)
c  done on  28/06/06 at  13.28.12
C PARAMETERs moved along eigenvector  8 by    -0.66317 dchi2=   2.66            
c evolution has been made starting at q2_input =      1.750
c  available for :       1.750 <= q2 <=   30000.000
