...
\begin{figure}[tbhp]
\begin{center}
     \includegraphics[width=0.64\textwidth,page=11]{{plots/jets}.pdf}
     \includegraphics[clip,trim=0 0 10cm 0.2cm,width=0.32\textwidth,page=12]{{plots/jets}.pdf}
\end{center}
\caption{
  ...
  The band indicates the uncertainties associated to the \DPDF.
}
\label{fig:}
\end{figure}
...
\end{center}
\caption{
  Comparison of (fitted) NNLO predictions using \DPDF\ (full line) to H1 LRG data taken with $\sqrt{s}=252\,\GeV$ at  $\xpom=0.003$ (full circles) as a function of $\beta$.
  Other details as in fig.~\ref{fig:comb_q2_xpom0p03}.
}
\label{fig:}
\end{figure}
...
\end{center}
\caption{
  Comparison of (fitted) NNLO predictions using \DPDF\ (full line) to H1 LRG data taken with $\sqrt{s}=252\,\GeV$ at  $\xpom=0.001$ (full circles) as a function of $\beta$.
  Other details as in fig.~\ref{fig:comb_q2_xpom0p03}.
}
\label{fig:}
\end{figure}
...
\end{center}
\caption{
  Comparison of (fitted) NNLO predictions using \DPDF\ (full line) to H1 LRG data taken with $\sqrt{s}=252\,\GeV$ at  $\xpom=0.0005$ (full circles) as a function of $\beta$.
  Other details as in fig.~\ref{fig:comb_q2_xpom0p03}.
}
\label{fig:}
\end{figure}
...
\end{center}
\caption{
  Ratio of NNLO pQCD predictions using \DPDF to H1 LRG data taken with $\sqrt{s}=252\,\GeV$ at  $\xpom=0.003$ (full circles) as a function of $\beta$.
  Other details as in fig.~\ref{fig:comb_q2_xpom0p03}.
}
\label{fig:}
\end{figure}
...
\end{center}
\caption{
  Ratio of NNLO pQCD predictions using \DPDF to H1 LRG data taken with $\sqrt{s}=252\,\GeV$ at  $\xpom=0.0005$ (full circles) as a function of $\beta$.
  Other details as in fig.~\ref{fig:comb_q2_xpom0p03}.
}
\label{fig:}
\end{figure}
...
\end{center}
\caption{
  Comparison of (fitted) NNLO predictions using \DPDF\ (full line) to H1 LRG data taken with $\sqrt{s}=225\,\GeV$ at  $\xpom=0.003$ (full circles) as a function of $\beta$.
  Other details as in fig.~\ref{fig:comb_q2_xpom0p03}.
}
\label{fig:}
\end{figure}
...
\end{center}
\caption{
  Comparison of (fitted) NNLO predictions using \DPDF\ (full line) to H1 LRG data taken with $\sqrt{s}=225\,\GeV$ at  $\xpom=0.0005$ (full circles) as a function of $\beta$.
  Other details as in fig.~\ref{fig:comb_q2_xpom0p03}.
}
\label{fig:}
\end{figure}
...
\end{center}
\caption{
  Ratio of NNLO pQCD predictions using \DPDF to H1 LRG data taken with $\sqrt{s}=225\,\GeV$ at  $\xpom=0.003$ (full circles) as a function of $\beta$.
  Other details as in fig.~\ref{fig:comb_q2_xpom0p03}.
}
\label{fig:}
\end{figure}
...
\end{center}
\caption{
  Ratio of NNLO pQCD predictions using \DPDF to H1 LRG data taken with $\sqrt{s}=225\,\GeV$ at  $\xpom=0.0005$ (full circles) as a function of $\beta$.
  Other details as in fig.~\ref{fig:comb_q2_xpom0p03}.
}
\label{fig:}
\end{figure}
